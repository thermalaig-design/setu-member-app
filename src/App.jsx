...
const TrustScopedRoute = ({ allowedTrustId, currentTrustId, fallbackPath = '/', children }) => {
  const location = useLocation();
  const normalizedAllowedTrustId = String(allowedTrustId || '').trim();
  const normalizedCurrentTrustId = String(currentTrustId || localStorage.getItem('selected_trust_id') || localStorage.getItem(LAST_SELECTED_TRUST_ID_KEY) || '').trim();

  if (!normalizedAllowedTrustId) {
    return <Navigate to={fallbackPath} replace />;
  }

  if (normalizedCurrentTrustId && normalizedCurrentTrustId !== normalizedAllowedTrustId) {
    ...
    >
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <ProtectedRoute>
              <TrustScopedRoute allowedTrustId={BASE_TRUST_ID} currentTrustId={activeTrustId} fallbackPath="/">
                <OrderHistory />
              </TrustScopedRoute>
            </ProtectedRoute>
          }
